...
def generate_host_quote(
    *,
    ...
    """
    Host quote calculation (monthly):
    - Prisoner wages
    - Instructor costs (apportioned by contracts + allocation%)
    - Overheads at 61%
    - Development charge (20% reduced based on employment support)
    """
    ...
    # Overheads: 61% of instructor cost (lock option)
